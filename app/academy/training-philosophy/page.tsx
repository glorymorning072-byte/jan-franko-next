...
export default function TrainingPhilosophyPage() {
  return <AcademyReferencePage eyebrow="The way of the bow" title="Training Philosophy" intro="Traditional archery taught through alignment, breath, awareness, cultural respect, and responsible practice in natural environments." sections={sections} />;
}
