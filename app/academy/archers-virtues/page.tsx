...
export default function ArchersVirtuesPage() {
  return <AcademyReferencePage eyebrow="Character before status" title="The Archer’s Virtues" intro="The Academy’s code of personal conduct: seven virtues expressed through safe practice, accurate attribution, humility, and care for others." sections={sections} />;
}
