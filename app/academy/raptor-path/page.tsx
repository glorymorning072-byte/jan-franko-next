...
export default function RaptorPathPage() {
  return <AcademyReferencePage eyebrow="A symbolic progression of archery mastery" title="The Raptor Path" intro="A training path that links archery skill with patience, awareness, responsibility, and character." sections={sections} ctaLabel="Request a rank evaluation" />;
}
