...
export default function SpecialPracticeRetreatsPage() {
  return <AcademyReferencePage eyebrow="Focused practice in small cohorts" title="Special Practice Retreats" intro="Immersive 24–96 hour formats that combine disciplined archery practice with carefully selected environmental and body-awareness modules." sections={sections} ctaLabel="Ask about a retreat" />;
}
